...
const firebaseConfig = {
  apiKey: 'AIzaSyAvvUG7ckkT-Hkk_dn53HYFSXUoA-dSZ9g',
  authDomain: 'ship-marketplace.firebaseapp.com',
  projectId: 'ship-marketplace',
  storageBucket: 'ship-marketplace.appspot.com',
  messagingSenderId: '698247952116',
  appId: '1:698247952116:web:8e701e8fb20bbae1d850a1',
};
...
const upload = async (fileName: string, file: File) => {
  const avatarRef = ref(firebaseStorage,  fileName);

  const task =  await uploadBytes(avatarRef, file.buffer);
